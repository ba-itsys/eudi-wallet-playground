...
public class SessionController {
    ...
    public ResponseEntity<?> issue(HttpSession httpSession,
                                   @RequestParam(value = "credentialConfigurationId", required = false) String configId) {
        WalletSession session = sessionService.getSession(httpSession);
    ...
    public ResponseEntity<?> mockIssue(HttpSession httpSession, HttpServletRequest request) {
        WalletSession session = sessionService.getSession(httpSession);
    ...
    public ResponseEntity<?> deleteCredential(@RequestParam("file") String file,
