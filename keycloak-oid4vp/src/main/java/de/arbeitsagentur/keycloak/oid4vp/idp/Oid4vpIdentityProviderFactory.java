    ...
    static {
        CONFIG_PROPERTIES = ProviderConfigurationBuilder.create()
                ...
                .property()
                    ...
                    .helpText("HTTPS URL of the wallet's OID4VP authorization endpoint. Defaults to local mock wallet at http://localhost:3000/oid4vp/auth.")
                    .type(ProviderConfigProperty.STRING_TYPE)
                    .defaultValue("http://localhost:3000/oid4vp/auth")
                    .add()
                .property()
